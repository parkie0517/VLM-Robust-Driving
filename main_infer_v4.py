...
dataset_dir = Path("/home/user/heejun/MO506/GroundingDINO/data/mo506_dataset/change_right")
...
If there is a cyclist or a car on the road but they are also going foward, then go straight.
...
"""
        ...
        anchor_traj = {
            ...
            'change_left_lane' : np.array([
                ...
                [443, 587],
                [454, 579],
                [465, 571]], dtype=np.int32),
            'change_right_lane' : np.array([
                [1280-541, 665],
                [1280-478, 635],
                [1280-444, 608],
                [1280-443, 587],
                [1280-454, 579],
                [1280-465, 571]], dtype=np.int32),
            'stop' : np.array([
                [640, 720],
                [640, 695],
                [640, 675],
        ...
        start_point = (640, 720)
        cv2.line(image_for_initial, start_point, tuple(points[0]), color=(0, 255, 0), thickness=3)
...
If the decision is 'change_left_lane', you do not need to modify the anchor much.
If the decision is 'change_right_lane', you do not need to modify the anchor much.
If 'turn left' or 'turn right', curve it accordingly.
If 'stop', shorten the trajectory near the current position.
If 'straight', adjust only the x values so that the trajectory better follows the center of the currnet road.
---
...
"""
        ...
        start_point = (640, 720)
        cv2.line(refined_image, start_point, tuple(refined_points[0]), color=(255, 0, 0), thickness=3)
